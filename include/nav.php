...
<header class="w3l-header">
	<div class="hero-header-11">
		<div class="hero-header-11-content">
			<div style='background: #c52c4d ;border-bottom: 1px solid #fff;padding: 10px 0px;'>
			...
			<div class="container" style='display:none;'>
				<nav class="navbar navbar-expand-lg navbar-light py-0 px-0">
					<a class="navbar-brand" href="index.php">
						<img class='logoImage' src="assets/images/biyanis education group.png" alt="Biyani's Jee Neet Private" title="Biyani's Jee Neet Private" />
					</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<div class="phone">
						  <a href="tel:+91 8898-512-070" style="display: block;"><span class="fa fa-phone" aria-hidden="true"></span> +91 8898-512-070</a>
						</div>
					</div>
				</nav>
			</div>
